...
- **Merged pull request:** <https://github.com/Nischoy-ai/topo/pull/17> (heartbeats, this slice); certificate rotation in <https://github.com/Nischoy-ai/topo/pull/16>; collector enrollment in <https://github.com/Nischoy-ai/topo/pull/14>; outbound mTLS in <https://github.com/Nischoy-ai/topo/pull/15>; ServiceNow IRE duplicate-CI validation in <https://github.com/Nischoy-ai/topo/pull/13>.
- **Merged commit:** `21e7478` (merge of `claude/next-repo-work-g2ihni` into `main`)
