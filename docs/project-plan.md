...
- **Merged pull request:** collector enrollment in <https://github.com/Nischoy-ai/topo/pull/14>; ServiceNow IRE duplicate-CI validation in <https://github.com/Nischoy-ai/topo/pull/13>; this slice's PR is pending at time of writing — see the repository's open pull requests for the current one.
