...
- **Merged pull request:** <https://github.com/Nischoy-ai/topo/pull/14> (collector enrollment; ServiceNow IRE duplicate-CI validation merged earlier in <https://github.com/Nischoy-ai/topo/pull/13>)
- **Merged commit:** `fe82ed6` (merge of `claude/next-repo-work-g2ihni` into `main`)
