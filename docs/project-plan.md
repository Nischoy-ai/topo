...
- **Merged pull request:** <https://github.com/Nischoy-ai/topo/pull/18> (job delivery, this slice — completes the milestone); heartbeats in <https://github.com/Nischoy-ai/topo/pull/17>; certificate rotation in <https://github.com/Nischoy-ai/topo/pull/16>; collector enrollment in <https://github.com/Nischoy-ai/topo/pull/14>; outbound mTLS in <https://github.com/Nischoy-ai/topo/pull/15>; ServiceNow IRE duplicate-CI validation in <https://github.com/Nischoy-ai/topo/pull/13>.
- **Merged commit:** `c9a31bf` (merge of `claude/next-repo-work-g2ihni` into `main`)
