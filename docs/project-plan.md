...
- **Merged pull request:** <https://github.com/Nischoy-ai/topo/pull/12> (systemd/Windows-service wrapping; Agent core loop merged earlier in <https://github.com/Nischoy-ai/topo/pull/11>)
- **Merged commit:** `a628a8a` (merge of `claude/next-repo-work-g2ihni` into `main`)
