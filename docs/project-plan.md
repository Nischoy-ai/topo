...
- **Merged pull request:** <https://github.com/Nischoy-ai/topo/pull/13> (ServiceNow IRE duplicate-CI validation; systemd/Windows-service wrapping merged earlier in <https://github.com/Nischoy-ai/topo/pull/12>)
- **Merged commit:** `7e84661` (merge of `claude/next-repo-work-g2ihni` into `main`)
