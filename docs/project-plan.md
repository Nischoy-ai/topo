...
- **Merged pull request:** <https://github.com/Nischoy-ai/topo/pull/16> (certificate rotation, this slice); collector enrollment in <https://github.com/Nischoy-ai/topo/pull/14>; outbound mTLS in <https://github.com/Nischoy-ai/topo/pull/15>; ServiceNow IRE duplicate-CI validation in <https://github.com/Nischoy-ai/topo/pull/13>.
- **Merged commit:** `f04e87e` (merge of `claude/next-repo-work-g2ihni` into `main`)
